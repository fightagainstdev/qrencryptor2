const zh_CN = {
    ...
    donation_message: "喜欢 qrencryptor 吗？您可以捐赠来支持本项目", // Love qrencryptor? You can donate to support the project.
    ...
    multiple_tabs_alert_notice_one: "qrencryptor 已经在另一标签窗口打开", // Looks like that Hat.sh is already open in another window/tab.
    ...
    file_not_encrypted_corrupted: "该文件不是使用 qrencryptor 加密的，或者文件已损坏！", // This file was not encrypted using qrencryptor or the file may be corrupted!
    old_version: "文件由老版本 qrencryptor 加密，访问 v1 版本来解密", // This file was encrypted using an older version of qrencryptor, you can decrypt this file by visiting the v1 app.
