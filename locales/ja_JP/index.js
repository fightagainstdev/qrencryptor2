const ja_JP = {
  ...
  changelog: "変更履歴",
  donation_message: "qrencryptorを気に入ってくれましたか? 寄付をすることでこのプロジェクトを支援できます。",
  ...
  file_not_encrypted_corrupted: "このファイルはqrencryptorを使用して暗号化されていないか、ファイルが破損している可能性があります！",
  old_version: "このファイルは古いバージョンのqrencryptorを使用して暗号化されています。v1アプリにアクセスして復号化することができます。",
